(function() {
  ...
  actionForUrl = function(url) {
    return options.ready.then(function() {
      ...
      var attached, condition, condition2Str, current, currentName, details, direct, icon, name, profile, profileColor, realCurrentName, result, resultColor, results, _i, _len, _ref, _ref1;
